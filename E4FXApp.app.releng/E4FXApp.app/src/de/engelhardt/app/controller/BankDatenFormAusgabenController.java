...
public class BankDatenFormAusgabenController extends BankDatenBaseForm{
	private static final Logger logger = LoggerFactory.getLogger(BankDatenFormAusgabenController.class);

	@Inject
    @Optional
	public void handleImport(@UIEventTopic(Constants.EVNT_AUSGABEN) List<KontoEntity> lst) {
